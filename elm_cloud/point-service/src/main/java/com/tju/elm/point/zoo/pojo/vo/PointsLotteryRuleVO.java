...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "积分抽奖规则VO")
public class PointsLotteryRuleVO {
    ...
    @Schema(description = "适用会员等级 1-白银 2-黄金 3-钻石")
