...
//    private OrderDetailetMapper orderDetailetMapper;
    ...
    public List<PointsExchangeGoodsVO> getExchangeGoodsList() {
        ...
        for (MarketingPointsExchangeRule rule : rules) {
            ...
            // 查询商品信息
            Food food = foodClient.gainFoodId(rule.getFoodId()).getData();
    ...
    public Long exchangeGoods(Long userId, PointsExchangeDTO dto) {
        ...
        Food food = foodClient.gainFoodId(dto.getFoodId()).getData();
        if (food == null) {
        ...
        pointsService.deductPoints(deductDTO,userId);
