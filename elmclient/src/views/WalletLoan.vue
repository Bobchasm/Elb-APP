      ...
      <div v-else class="loans-content">
        ...
        <div class="loans-list">
          ...
          >
            ...
            <div class="loan-info">
              ...
              <div class="loan-details">
                ...
                <!-- <div v-else class="loan-pending">
                  <i class="fas fa-clock"></i>
                  <span class="label">状态：</span>
                  <span class="pending-text">待还款</span>
                </div> -->
              </div>
              <div class="loan-actions" v-if="!loan.repayTime">
                <button class="repay-btn" @click="showRepayModal(loan)">
          ...
          <div v-if="filteredLoans.length === 0" class="empty-state">
            ...
            <p v-else>暂无贷款记录</p>
            <!-- <button class="retry-btn" @click="fetchLoans">
            ...
            <div class="repay-summary">
              ...
              <div class="repay-details">
                <!-- <div class="detail-item">
                  <span class="detail-label">贷款编号：</span>
      ...
      const handleRepay = async () => {
        ...
        try {
          ...
          const response = await request.get('/api/wallet/loan/repay', {
            params: { id: currentLoan.value.id }
          });
